...
\item An increase in the number of clicks participants have to make.
...
Figure~\ref{utests} shows the TortoisGit log after a successful commit. If one of the tests were to fail, the commit is cancelled. 
\begin{figure}[h]
	\includegraphics[width=1\linewidth]{UnitTests.PNG}
	\caption{}
	\label{utests}
\end{figure}
