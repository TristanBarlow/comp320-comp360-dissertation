...
\resizebox{\columnwidth}{!}{\begin{tabular}{|l|l|l|l|l|}
		\hline
		\textbf{Object Type} & \textbf{\textit{P}-Value}& \textbf{\textit{T}-Value} & \textbf{Effect Size}& \textbf{Mean Ratio MI/No MI}\\\hline
